                            ...
                            <div class="col-4 d-flex align-items-center">
                                <div class="position-relative d-inline-block">
                                    <img id="current-profile-image" class="img-fluid img-thumbnail rounded-5"
                                        src="{{ $user->kaprodi->gambar ? asset($user->kaprodi->gambar) : asset('assets/images/profile/user-1.jpg') }}"
                                        alt="Profile Image">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input readonly type="text" class="form-control disabled-input"
                                                    id="fakultas" name="fakultas"
                                                    value="{{ old('fakultas', $user->kaprodi->fakultas->nama) }}">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                    ...
                    <form action="{{ route('mahasiswa.profile.update') }} " method="POST"
                        ...
                        <div class="row">
                            <div class="col-4 d-flex align-items-center">
                                <div class="position-relative d-inline-block">
                                    <img id="current-profile-image" class="img-fluid img-thumbnail rounded-5"
                                        src="{{ $user->mahasiswa->poto }}" alt="Profile Image">
                                    <span class="position-absolute top-0 end-0 p-4">
                                        <div id="profile-image" class="bg-white p-2 rounded-2 cursor-pointer">
                                            <i class="fas fa-camera fs-5"></i>
                                        </div>
